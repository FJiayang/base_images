...
| `node22-python313-docker` | python:3.13-bookworm | Python 3.13, Node.js 22, uv, Docker CLI, git, yq |
...
docker pull ghcr.io/fjiayang/gitea-runner:node22-python313-docker
```
...
│   └── Dockerfile.node22-python313-docker
├── resources/               # 额外资源文件
